...
def build_pixel_decoder(cfg, input_shape):
    """
    Build a pixel decoder from `cfg.MODEL.PanSR.PIXEL_DECODER_NAME`.
    """
...
class PanSREncoder(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        self.num_feature_levels_used = num_feature_levels  # always use 3 scales
    ...
    def from_config(cls, cfg, input_shape: Dict[str, ShapeSpec]):
        ...
        ret["transformer_dropout"] = cfg.MODEL.PanSR.DROPOUT
        ret["transformer_nheads"] = cfg.MODEL.PanSR.NHEADS
