...
from ..transformer_decoder.pansr_decoder import build_transformer_decoder
from ..pixel_decoder.pansr_encoder import build_pixel_decoder


@SEM_SEG_HEADS_REGISTRY.register()
class PanSRHead(nn.Module):
    @configurable
    def __init__(
        self,
